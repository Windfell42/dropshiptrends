...
class TrendDataProvider
{
    ...
    private const PRODUCTS = [
        ['name' => 'Portable Blender',            'cat' => 'Kitchen',       'base' => 82, 'peak' => 6,  'price' => 29.99],
        ['name' => 'LED Strip Lights',             'cat' => 'Home Decor',   'base' => 90, 'peak' => 12, 'price' => 14.99],
        ['name' => 'Posture Corrector',            'cat' => 'Health',       'base' => 75, 'peak' => 1,  'price' => 19.99],
        ['name' => 'Phone Camera Lens Kit',        'cat' => 'Electronics',  'base' => 68, 'peak' => 11, 'price' => 24.99],
        ['name' => 'Resistance Bands Set',         'cat' => 'Fitness',      'base' => 88, 'peak' => 1,  'price' => 12.99],
        ['name' => 'Car Phone Mount',              'cat' => 'Auto',         'base' => 72, 'peak' => 7,  'price' => 15.99],
        ['name' => 'Heated Blanket',               'cat' => 'Home',         'base' => 65, 'peak' => 11, 'price' => 44.99],
        ['name' => 'Bluetooth Earbuds',            'cat' => 'Electronics',  'base' => 95, 'peak' => 12, 'price' => 34.99],
        ['name' => 'Pet Grooming Glove',           'cat' => 'Pets',         'base' => 70, 'peak' => 4,  'price' => 9.99],
        ['name' => 'Ring Light',                   'cat' => 'Electronics',  'base' => 85, 'peak' => 9,  'price' => 27.99],
        ['name' => 'Yoga Mat',                     'cat' => 'Fitness',      'base' => 80, 'peak' => 1,  'price' => 22.99],
        ['name' => 'Smart Watch Band',             'cat' => 'Accessories',  'base' => 78, 'peak' => 12, 'price' => 11.99],
        ['name' => 'Portable Projector',           'cat' => 'Electronics',  'base' => 60, 'peak' => 11, 'price' => 79.99],
        ['name' => 'Reusable Water Bottle',        'cat' => 'Fitness',      'base' => 76, 'peak' => 6,  'price' => 16.99],
        ['name' => 'Electric Scalp Massager',      'cat' => 'Health',       'base' => 55, 'peak' => 2,  'price' => 18.99],
        ['name' => 'Wireless Charging Pad',        'cat' => 'Electronics',  'base' => 83, 'peak' => 12, 'price' => 19.99],
        ['name' => 'Silicone Kitchen Utensil Set', 'cat' => 'Kitchen',      'base' => 62, 'peak' => 5,  'price' => 21.99],
        ['name' => 'Neck Fan',                     'cat' => 'Personal',     'base' => 58, 'peak' => 7,  'price' => 17.99],
        ['name' => 'Sunset Lamp Projector',        'cat' => 'Home Decor',   'base' => 73, 'peak' => 10, 'price' => 23.99],
        ['name' => 'Mini Waffle Maker',            'cat' => 'Kitchen',      'base' => 69, 'peak' => 3,  'price' => 15.99],
        ['name' => 'Beard Trimmer Kit',            'cat' => 'Grooming',     'base' => 71, 'peak' => 11, 'price' => 26.99],
        ['name' => 'Laptop Stand',                 'cat' => 'Office',       'base' => 77, 'peak' => 9,  'price' => 32.99],
        ['name' => 'Insulated Tumbler',            'cat' => 'Kitchen',      'base' => 86, 'peak' => 6,  'price' => 18.99],
        ['name' => 'Magnetic Phone Case',          'cat' => 'Accessories',  'base' => 64, 'peak' => 12, 'price' => 14.99],
        ['name' => 'Ice Roller Face Massager',     'cat' => 'Beauty',       'base' => 59, 'peak' => 7,  'price' => 8.99],
        ['name' => 'Desk Organizer',               'cat' => 'Office',       'base' => 66, 'peak' => 9,  'price' => 24.99],
        ['name' => 'Electric Lighter',             'cat' => 'Gadgets',      'base' => 53, 'peak' => 12, 'price' => 12.99],
        ['name' => 'Cloud Slides Slippers',        'cat' => 'Fashion',      'base' => 81, 'peak' => 3,  'price' => 19.99],
        ['name' => 'Magnetic Eyelashes',           'cat' => 'Beauty',       'base' => 67, 'peak' => 2,  'price' => 13.99],
        ['name' => 'Solar Power Bank',             'cat' => 'Electronics',  'base' => 74, 'peak' => 6,  'price' => 29.99],
        ['name' => 'Acupressure Mat',              'cat' => 'Health',       'base' => 56, 'peak' => 1,  'price' => 27.99],
        ['name' => 'LED Desk Lamp',                'cat' => 'Office',       'base' => 63, 'peak' => 9,  'price' => 22.99],
        ['name' => 'Digital Kitchen Scale',        'cat' => 'Kitchen',      'base' => 61, 'peak' => 1,  'price' => 11.99],
        ['name' => 'Foldable Travel Bag',          'cat' => 'Travel',       'base' => 79, 'peak' => 6,  'price' => 16.99],
        ['name' => 'Teeth Whitening Kit',          'cat' => 'Beauty',       'base' => 84, 'peak' => 5,  'price' => 32.99],
        ['name' => 'Sterling Silver Chain Necklace','cat' => 'Jewelry',     'base' => 72, 'peak' => 12, 'price' => 24.99],
        ['name' => 'Cubic Zirconia Ring Set',      'cat' => 'Jewelry',      'base' => 65, 'peak' => 2,  'price' => 18.99],
        ['name' => 'Beaded Bracelet Collection',   'cat' => 'Jewelry',      'base' => 58, 'peak' => 5,  'price' => 11.99],
        ['name' => 'Dash Cam Recorder',            'cat' => 'Auto',         'base' => 76, 'peak' => 8,  'price' => 49.99],
        ['name' => 'Car Seat Organizer',           'cat' => 'Auto',         'base' => 63, 'peak' => 6,  'price' => 17.99],
        ['name' => 'Jade Roller Set',              'cat' => 'Beauty',       'base' => 62, 'peak' => 3,  'price' => 10.99],
        ['name' => 'USB Desk Fan',                 'cat' => 'Office',       'base' => 57, 'peak' => 7,  'price' => 14.99],
        ['name' => 'Foam Roller',                  'cat' => 'Fitness',      'base' => 73, 'peak' => 1,  'price' => 19.99],
        ['name' => 'Essential Oil Diffuser',       'cat' => 'Home',         'base' => 77, 'peak' => 11, 'price' => 21.99],
        ['name' => 'Pet Water Fountain',           'cat' => 'Pets',         'base' => 66, 'peak' => 6,  'price' => 28.99],
        ['name' => 'Tire Pressure Gauge',          'cat' => 'Auto',         'base' => 54, 'peak' => 5,  'price' => 9.99],
        ['name' => 'Clip-On Reading Light',        'cat' => 'Office',       'base' => 52, 'peak' => 9,  'price' => 12.99],
        ['name' => 'Layered Pendant Necklace',     'cat' => 'Jewelry',      'base' => 69, 'peak' => 12, 'price' => 21.99],
        ['name' => 'Vitamin Organizer Case',       'cat' => 'Health',       'base' => 60, 'peak' => 1,  'price' => 8.99],
        ['name' => 'Car Trunk Organizer',          'cat' => 'Auto',         'base' => 58, 'peak' => 4,  'price' => 22.99],
        ['name' => 'Hair Claw Clips Set',          'cat' => 'Fashion',      'base' => 75, 'peak' => 8,  'price' => 7.99],
        ['name' => 'Mini Portable Speaker',        'cat' => 'Electronics',  'base' => 71, 'peak' => 6,  'price' => 24.99],
        ['name' => 'Silicone Baking Mat Set',      'cat' => 'Kitchen',      'base' => 64, 'peak' => 11, 'price' => 13.99],
        ['name' => 'Ankle Brace Support',          'cat' => 'Health',       'base' => 56, 'peak' => 3,  'price' => 14.99],
    ];
